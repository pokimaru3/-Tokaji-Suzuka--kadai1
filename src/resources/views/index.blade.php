...
<div class="register-form__content">
    ...
    <form class="form" action="/confirm" method="post">
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--text">
                    <input type="text" name="tel1" value="{{ old('tel1', $formData['tel1'] ?? '') }}" placeholder="080"> -
                    <input type="text" name="tel2" value="{{ old('tel2', $formData['tel2'] ?? '') }}" placeholder="1234"> -
                    <input type="text" name="tel3" value="{{ old('tel3', $formData['tel3'] ?? '') }}" placeholder="5678">
                </div>
                <div class="form__error">
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <div class="form__input--text">
                    <input type="text" name="building" placeholder="例: 千駄ヶ谷マンション101" value="{{ old('building', $formData['building'] ?? '') }}">
                </div>
                <div class="form__error">
                    @error('building')
                    {{ $message }}
        ...
        <div class="form__group">
            ...
            <div class="form__group-content">
                <textarea name="detail" placeholder="お問い合わせ内容をご記載ください">{{ old('detail', $formData['detail'] ?? '') }}</textarea>
                <div class="form__error">
                    @error('detail')
                        {{ $message }}
                    @enderror
